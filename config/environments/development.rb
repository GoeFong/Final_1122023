...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    user_name:       'ttphong090301@gmail.com',
    password:        'tnapgyaymmjbhlyr',
  ...
  ENV['CALLBACK_URL'] = Rails.application.credentials.dig(:callback_url)
  ...
  # config.action_mailer.delivery_method = :smtp
  # config.action_mailer.smtp_settings = {
  #   :user_name => '3b1781816eb521',
  #   :password => '6291cd7a3152ae',
